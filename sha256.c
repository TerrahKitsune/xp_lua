...
This implementation uses little endian SHA_BYTE order.
*********************************************************************/
...
void sha256_final(SHA256_CTX *ctx, SHA_BYTE hash[])
{
	...
	// Since this implementation uses little endian SHA_BYTE ordering and SHA uses big endian,
	// reverse all the SHA_BYTEs when copying the final state to the output hash.
	for (i = 0; i < 4; ++i) {
